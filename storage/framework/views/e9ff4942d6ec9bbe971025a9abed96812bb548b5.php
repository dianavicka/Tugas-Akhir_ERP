    ...
    <footer class="main-footer">
        <div class="footer-left">
            ERP &copy; 2023 <div class="bullet"></div> Design By <a href="https://nauval.in/">Diana Vicka</a>
        </div>
        <div class="footer-right">
            Credit From <i class="fas fa-heart text-danger"></i> oleh <a href="https://rafipriatna.id" target="_blank" rel="noopener noreferrer">Rafi Priatna K</a>
        </div>
    </footer><?php /**PATH D:\ERP Diana Vicka\LaraPOS\resources\views/layouts/footer.blade.php ENDPATH**/ ?>