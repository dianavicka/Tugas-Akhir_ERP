<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <a href="{{ route('home') }}" class="nav-link"><i class="ion-android-home"></i> <span>Menu Utama</span></a>
      </li>
      ...
      @if (Auth::user()->roles == 'admin')
        ...
        <li class="{{ (Request::url() === route('product.index')
          ...
          <li class="{{ (Request::url() === route('customer.index')) ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('customer.index') }}"><i class="ion-person-stalker"></i> <span>Klien</span></a>
          </li>
