    ...
    <footer class="main-footer">
        <div class="footer-left">
            ERP &copy; 2023 <div class="bullet"></div> Design By <a href=>Diana Vicka</a>
        </div>
        <div class="footer-right">
            Credit From <i class="fas fa-heart text-danger"></i> oleh <a href=target="_blank" rel="noopener noreferrer">Rafi Priatna K</a>
        </div>
    </footer>